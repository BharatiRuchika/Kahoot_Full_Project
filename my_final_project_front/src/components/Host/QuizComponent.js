...
function QuizComponent(props){
    ...
    const getQuizzes=async()=>{
        ...
        var response = await axios.get(`/quiz/getQuizzes`,{
            headers:{
                'auth-token':token
            }
            });
    ...
    const setRedirect = async(e)=>{
        var response = await axios.get(`/quizquestions/getQuestions/${e._id}`,{
            headers:{
              'auth-token':token
            }
          });
    ...
    const deleteQuiz = async(id)=>{
        ...
        // }else{
       var res =  await axios.delete(`/quiz/deleteQuiz/${id}`,{
           headers:{
               'auth-token':token
           }
       })
